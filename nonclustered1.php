...
{
    $cin_id = $_POST['cin_id'];
    $result = mysqli_query( $connector, "SELECT * FROM melanoma_noncluster WHERE cin_id='$cin_id'");
    if(is_bool($result))
    {
...
if(isset($_POST['Submit2']))
{
    ...
    $result = mysqli_query( $connector, "SELECT * FROM melanoma_noncluster WHERE case_no='$case_no'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
...
{
    $sex = $_POST['sex'];
    $result = mysqli_query( $connector, "SELECT * FROM melanoma_noncluster WHERE sex='$sex'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
...
{
    $age = $_POST['age'];
    $result = mysqli_query( $connector, "SELECT * FROM melanoma_noncluster WHERE age='$age'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
...
{
    $biopsy = $_POST['biopsy'];
    $result = mysqli_query( $connector, "SELECT * FROM melanoma_noncluster WHERE biopsy='$biopsy'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
...
{
    $p16 = $_POST['p16'];
    $result = mysqli_query( $connector, "SELECT * FROM melanoma_noncluster WHERE p16='$p16'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
...
{
    $vas = $_POST['vas'];
    $result = mysqli_query( $connector, "SELECT * FROM melanoma_noncluster WHERE vas='$vas'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
...
{
    $gel = $_POST['gel'];
    $result = mysqli_query( $connector, "SELECT * FROM melanoma_noncluster WHERE gel='$gel'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
...
{
    $cell = $_POST['cell'];
    $result = mysqli_query( $connector, "SELECT * FROM melanoma_noncluster WHERE cell='$cell'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
...
if(isset($_POST['Submit10']))
{
    ...
    $result = mysqli_query( $connector, "SELECT * FROM melanoma_noncluster WHERE scratch='$scratch'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
