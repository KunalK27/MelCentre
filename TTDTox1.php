...
{
    $ttdtox_id = $_POST['ttdtox_id'];
    $result = mysqli_query( $connector, "SELECT * FROM ttdtox WHERE ttdtox_id='$ttdtox_id'");
    if(is_bool($result))
    {
...
{
    $source = $_POST['source'];
    $result = mysqli_query( $connector, "SELECT * FROM ttdtox WHERE source='$source'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
...
{
    $mol = $_POST['mol'];
    $result = mysqli_query( $connector, "SELECT * FROM ttdtox WHERE mol='$mol'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
...
{
    $dmp = $_POST['dmp'];
    $result = mysqli_query( $connector, "SELECT * FROM ttdtox WHERE dmp='$dmp'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
...
{
    $state = $_POST['state'];
    $result = mysqli_query( $connector, "SELECT * FROM ttdtox WHERE state='$state'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
...
if(isset($_POST['Submit6']))
{
    ...
    $result = mysqli_query( $connector, "SELECT * FROM ttdtox WHERE modifier='$modifier'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
...
{
    $rel = $_POST['rel'];
    $result = mysqli_query( $connector, "SELECT * FROM ttdtox WHERE rel='$rel'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
...
{
    $model = $_POST['model'];
    $result = mysqli_query( $connector, "SELECT * FROM ttdtox WHERE model='$model'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
...
{
    $h = $_POST['h'];
    $result = mysqli_query( $connector, "SELECT * FROM ttdtox WHERE h='$h'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
...
{
    $ref = $_POST['ref'];
    $result = mysqli_query( $connector, "SELECT * FROM ttdtox WHERE ref='$ref'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
