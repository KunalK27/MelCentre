...
Any molecule (in its particular functional state) and the toxicity of any therapeutic agent
being used or being investigated for the treatment of melanoma (toxicity relationship)
          </div>
        </div>
        <div>
          <div style="text-align: center;" >
              <div style="text-align: center;">
                <br>
                <form method="POST" action="TTDSyn1.php">
                <label for="ttdsyn_id">TTDSyn_ID:</label>
                <input type="text" id="ttdsyn_id" name="ttdsyn_id">
    ...
    $result = mysqli_query( $connector, "SELECT * FROM ttdysn");
    ?>
     <table> 
        <thead>
            <tr>
