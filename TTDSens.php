...
Any molecule (in its particular functional state) and the anti-melanoma efficacy of a
therapeutic agent being used or being investigated for the treatment of melanoma (relationship
of sensitivity / resistance)
        ...
        <div>
          <div style="text-align: center;" >
              <div style="text-align: center;">
                <br>
                <form method="POST" action="TTDSens1.php">
                <label for="ttdsens_id">TTDSens_ID:</label>
                <input type="text" id="ttdsens_id" name="ttdsens_id">
              ...
              <form method="POST" action="TTDSens1.php">
                ...
                <input type="text" id="mod" name="modifier">
    ...
    $result = mysqli_query( $connector, "SELECT * FROM ttdsens");
    ?>
     <table> 
        <thead>
            <tr>
