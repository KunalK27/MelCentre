...
{
    $mmmp_id = $_POST['mmmp_id'];
    $result = mysqli_query( $connector, "SELECT * FROM mmmp_biomap WHERE mmmp_id='$mmmp_id'");
    if(is_bool($result))
    {
...
{
    $biomapn = $_POST["biomapn"];
    $result = mysqli_query( $connector, "SELECT * FROM mmmp_biomap WHERE biomapname='$biomapn'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
...
{
    $biomapl = $_POST["biomapl"];
    $result = mysqli_query( $connector, "SELECT * FROM mmmp_biomap WHERE biomaplink='$biomapl'");
    if(is_bool($result))
    {
        echo "No such Record in the table";
    }
